...
export const HeroSection = ({ onCTAClick }: HeroSectionProps) => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute right-4 md:right-20 top-1/4 opacity-20 hidden md:block"
        animate={{ rotate: 360 }}
      ...
      <div className="relative z-10 container max-w-4xl mx-auto px-5 py-20 text-center">
        ...
        <h1 className="heading-hero text-primary-foreground mb-6">
          <TypewriterText
            text="Trabalha o mês inteiro mas no fim só sobra o cansaço?"
            delay={500}
          />
        </h1>
